(module
 ...
 (import "__asCovers" "coverDeclare" (func $packages/assembly/index/__coverDeclare (param i32 i32 i32 i32 i32)))
 (import "__asCovers" "cover" (func $packages/assembly/index/__cover (param i32)))
 (import "env" "trace" (func $~lib/builtins/trace (param i32 i32 f64 f64 f64 f64 f64)))
 (import "env" "abort" (func $~lib/builtins/abort (param i32 i32 i32 i32)))
 (global $packages/assembly/index/CoverType.Function i32 (i32.const 0))
 (global $packages/assembly/index/CoverType.Block i32 (i32.const 1))
 (global $packages/assembly/index/CoverType.Expression i32 (i32.const 2))
 ...
 (data (i32.const 60) "\1c\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\n\00\00\00h\00e\00l\00l\00o\00\00\00")
 (data (i32.const 92) "L\00\00\00\00\00\00\00\00\00\00\00\01\00\00\004\00\00\00p\00a\00c\00k\00a\00g\00e\00s\00/\00a\00s\00s\00e\00m\00b\00l\00y\00/\00i\00n\00d\00e\00x\00.\00t\00s\00\00\00\00\00\00\00\00\00")
 ...
 (table $0 1 funcref)
 (elem $0 (i32.const 1))
 (export "CoverType.Function" (global $packages/assembly/index/CoverType.Function))
 (export "CoverType.Block" (global $packages/assembly/index/CoverType.Block))
 (export "CoverType.Expression" (global $packages/assembly/index/CoverType.Expression))
 ...
 (func $~start
  ...
  global.set $~started
  call $start:myTest
  call $start:packages/assembly/index
  memory.size
  i32.const 16
  i32.shl
  global.get $~lib/memory/__heap_base
 ...
 (func $start:myTest
  ...
  i32.const 1
  i32.const 1
  call $packages/assembly/index/__coverDeclare
  i32.const 32
  local.set $0
  global.get $~lib/memory/__stack_pointer
  local.get $0
  ...
  call $packages/assembly/index/__coverDeclare
  i32.const 0
  call $packages/assembly/index/__cover
  i32.const 80
  local.set $0
  global.get $~lib/memory/__stack_pointer
  local.get $0
 ...
 (func $start:packages/assembly/index
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
